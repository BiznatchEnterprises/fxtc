...
public:
    ...
    // Firewall
    std::atomic<int> nSyncHeight;
    std::atomic<int> nSyncHeightOld;
    std::atomic<double> nTrafficAverage;
    std::atomic<double> nTrafficRatio;
    std::atomic<int> nTrafficTimestamp;
